...
public class InfoCommand extends ICommand {
    ...
    private final String HELP = "La commande `"+ this.commandName +"` affiche des informations sur l'état courant du bot. \nUsage: `!" + this.commandName + "`";
    ...
    public void action(String[] args, MessageReceivedEvent event) {
        ...
        builder.addField("Utilisateurs :busts_in_silhouette:", String.valueOf(usersNumber), true);
        builder.addField("Serveurs :desktop:", String.valueOf(serversNumber), true);
        builder.addField("Salons :keyboard: :loud_sound:", String.valueOf(channelNumber) + " texte / " + String.valueOf(voiceChannelNumber) + " vocal \n", true);
