...
public class ServerSettingsCommand extends ICommand {
    ...
    private final String HELP = "La commande `"+ this.commandName +"` affiche les différents réglages pour le serveur. \nUsage: `!" + this.commandName + "`";
    private final String BLANK_PROPERTY = "Pas encore paramétré";
    ...
    public void action(String[] args, MessageReceivedEvent event) {
        try {
            ...
            builder.setAuthor("Paramètres du serveur");
